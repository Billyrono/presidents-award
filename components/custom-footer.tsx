    ...
    <footer className="bg-foreground text-white">
      <div className="max-w-6xl mx-auto px-4 md:px-8 py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-12">
          {/* Brand */}
          <div>
            <h3 className="text-2xl font-display font-bold mb-2">President&apos;s Award</h3>
            <p className="text-white/70 text-sm font-semibold">Kirinyaga University Chapter</p>
            ...
            <form onSubmit={handleNewsletter} className="flex gap-2">
              <div className="relative flex-1">
                ...
                <input
                  ...
                  required
                  className="w-full bg-white/10 border border-white/15 rounded-lg pl-9 pr-3 py-2.5 text-sm text-white placeholder:text-white/40 focus:outline-none focus:border-primary/60 transition-colors"
                />
              </div>
              <button
                type="submit"
                className="bg-primary hover:bg-primary/80 text-white px-4 py-2.5 rounded-lg text-sm font-semibold transition-colors whitespace-nowrap"
              >
                Subscribe
              </button>
            </form>
        ...
        <div className="border-t border-white/10 pt-8 flex flex-col md:flex-row items-center justify-between gap-4">
          <p className="text-sm text-white/60 flex items-center gap-2">
            Made with <Heart className="w-4 h-4 text-accent" /> for Kenya&apos;s future leaders
          </p>
